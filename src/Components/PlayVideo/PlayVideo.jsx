...
const PlayVideo = () =>{
    ...
    console.log(channelData?channelData.snippet:"");
    ...
    return (
        <div className='play-video'>
            ...
            <div className="play-video-info">
                <p>{apiData?value_converter(apiData.statistics.viewCount):"16K"} Views &bull; {moment(apiData?apiData.snippet.publishedAt:"2days ago").fromNow()}</p>
                <div>
            ...
            <div className="publisher">
                ...
                <form onClick={subscribeBut}>
                {subscribe?<button >Subscribe</button>:<button style={{background:"black"}}>Subscribed</button>}
                </form>
            </div>
